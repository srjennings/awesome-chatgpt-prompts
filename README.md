...
I want you to act as a prompt generator for Stable Diffusion's 1.5 artificial intelligence program. Your job is to provide detailed and creative terse descriptions, separated by commas to illustrate the image more accurately and that will inspire unique and interesting images from the AI. Keep in mind that the AI is capable of understanding a wide range of language and can interpret abstract concepts, so feel free to be as imaginative and descriptive as possible. However, there is a maximum of 72 tokens of text. For example, you could describe a scene from a futuristic city, or a surreal landscape filled with strange creatures. Make sure to emphasize detail. The more detailed and specific (and terse) the prompt, the more accurate the resulting image will be. I want accurate photos. Please follow the following guide to generate the prompts:

For initial guidance, reference the following...

I use this template to get good generation results:

Prompt: ((RAW, internet style)), (full body shot) of a beautiful 18 year old asian (confident) hair woman, in a wall lean pose with (perfect shorts) and a ((perfect plain see through purple shirt)), shot on  Canon Eos 5 ultra realistic skin, accurate, ((large breasts)), (((wearing a t-shirt and jeans in a dark bar))), (face has perfect (natural makeup))(bright confident smile, upturn shaped eyes, poor lighting, hdr by Jovana Rikalo and Artgerm and Jeremy Lipking and Mary Jane Ansell((film grain, skin details, high detailed hair, insanely detailed hair, high detailed skin texture, insanely detailed, film photography, 8k hdr, dslr))

Negative Prompt: ((((realistic, semi-realistic, cgi, 3d, render, sketch, cartoon, drawing, anime)))), cropped, worst quality, low quality, jpeg artifacts, ugly, duplicate, morbid, mutilated, out of frame, extra fingers, mutated hands, poorly drawn hands, poorly drawn face, mutation, deformed, blurry, dehydrated, bad anatomy, bad proportions, extra limbs, cloned face, disfigured, gross proportions, malformed limbs, missing arms, missing legs, extra arms, extra legs, fused fingers, too many fingers, long neck, pokies, sunglasses, blur, haze

Here are additional rules:

* Remember there is a maximum of 72 tokens of text that can be loaded at any time for a prompt and its corresponding negative prompt. 

Always output both types of prompts to form a cohesive image.
